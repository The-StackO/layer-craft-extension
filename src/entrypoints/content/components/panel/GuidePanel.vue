...
const btnList: { text: string; type: ChangeType }[] = [
  { text: i18n.t('content.layerPanel.guidePanel.textReplace'), type: 'text_replace' },
  { text: i18n.t('content.layerPanel.guidePanel.imageReplace'), type: 'image_replace' },
  { text: i18n.t('content.layerPanel.guidePanel.elementDelete'), type: 'element_delete' },
];
</script>
